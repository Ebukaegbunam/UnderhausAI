...
export default function Contrast() {
  return (
    <section id="contrast" className="py-16 md:py-20 border-t border-b border-[rgba(26,24,20,0.08)]">
      <div className="max-w-[1280px] mx-auto px-4 md:px-8 relative z-[2]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="p-6 md:p-9 md:border-r border-b md:border-b-0 border-[rgba(26,24,20,0.08)]">
            <div className="font-mono text-[11px] tracking-widest uppercase text-[#9A9288] mb-4">What the portals tell you</div>
            <ul className="list-none p-0 m-0">
              {LEFT.map((item, i) => (
                <li key={i} className="font-['Instrument_Serif'] text-[20px] md:text-[22px] font-medium leading-[1.4] py-4 border-b border-[rgba(26,24,20,0.08)] last:border-0 text-[#5C564E] flex items-baseline gap-3.5">
          ...
          <div className="p-6 md:p-9" style={{ background: '#F3EEE4' }}>
            <div className="font-mono text-[11px] tracking-widest uppercase text-[#9A9288] mb-4">What Underhaus tells you</div>
            <ul className="list-none p-0 m-0">
              {RIGHT.map((item, i) => (
                <li key={i} className="font-['Instrument_Serif'] text-[20px] md:text-[22px] font-medium leading-[1.4] py-4 border-b border-[rgba(26,24,20,0.08)] last:border-0 flex items-baseline gap-3.5" style={{ color: '#1A1814' }}>
